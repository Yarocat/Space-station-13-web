  ...
  return (
    <header className="h-12 bg-neutral-950 border-b border-neutral-800 flex items-center justify-between px-4 text-xs font-mono select-none z-30">
      ...
      <div className="flex items-center gap-2">
        ...
        {/* Sound Toggle & Channels */}
        <div className="flex items-center bg-neutral-900 border border-neutral-800 rounded-lg p-0.5">
          <button
            id="toggle-audio-btn"
            onClick={handleToggleAudio}
            title={audioActive ? 'Mute Master Audio' : 'Unmute Master Audio'}
          ...
          {onOpenSoundSettings && (
            <button
              ...
              title="Spatial Sound Channels & Volume Mix"
        ...
        {/* TGStation & Griefly DMI Loader Button */}
        {onOpenDmiManager && (
          <button
            id="dmi-assets-btn"
            onClick={onOpenDmiManager}
            title="TGStation & Griefly DMI Asset Loader"
            className="p-2 rounded-lg bg-neutral-900 border border-neutral-800 text-amber-400 hover:text-amber-200 hover:bg-neutral-800 transition-colors flex items-center gap-1.5"
          >
            <FolderGit2 className="w-3.5 h-3.5" />
            <span className="hidden md:inline text-[11px] font-bold">DMI Assets</span>
          </button>
        )}
